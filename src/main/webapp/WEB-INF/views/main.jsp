...
<body>
  <div id = 'head' class="header">
    <img src="/img/Logo.png" style = "margin-right: 1350px;" alt="로고" width="200px" height="65px" onclick="location.href='main.jsp'">
    ...
    <div class="button-container" id="buttonContainer">
      ...
      <input class="button" type="button" id="loginBtn" value="로그인" style="margin: 7px; margin-right: 15px;" onclick="location.href='login.jsp'">
      <input class="button" type="button" id="joinBtn" value="회원가입" style="margin: 7px; margin-right: 15px;" onclick="location.href='join.jsp'">
    </div>
  ...
  <div class="nav__bar">
    <ul class="nav__menu">
      ...
      <li><a href="free_boardList.jsp" style="margin-top: 15px; margin-left: 10px;" class="white_font"> 후기 목록 </a></li>
      <li><a href="free_boardList.jsp" style="margin-top: 15px; margin-left: 10px;" class="white_font"> 자유게시판 </a></li>
  ...
  <script type="text/javascript" >
      ...
      function CategoryClick(category) {
        ...
        try {
          axios.get(`http://35.212.196.164/ /freeboard/contentlist/${category}`)
                  .then(res => {
                    const dataArray = res.data;

                    // 데이터를 URL 매개변수로 전달하여 해당 카테고리의 후기목록 html로 이동
                    const queryParams = new URLSearchParams();
                    queryParams.append('data', JSON.stringify(dataArray));

                    // URL에 쿼리 매개변수 추가하여 이동
                    window.location.href = `store.html?${queryParams.toString()}`;
                  });
        } catch (error) {
