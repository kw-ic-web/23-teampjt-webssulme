...
<body>
  ...
  <div class="nav__bar">
    <ul class="nav__menu">
      ...
      <li><a href="mypage.jsp" style="margin-top: 10px; margin-left: 10px;" class="white_font"> 마이페이지 </a></li>
    </ul>
  </div>
</div>
  ...
  <script type="text/javascript" >
      ...
      if (queryParams.has('data')) {
          ...
          if (dataArray.length > 0) {
            ...
            <div class="title"><a href="store.html?idx=${item.id}">${item.comment}</a></div>
...
// Initial display of the first page
              ...
              pwc.textContent = '내가 쓴 알바 후기 글이 없습니다.';
