...
<body>
  ...
  <div class="nav__bar">
    <ul class="nav__menu">
      ...
      <li><a href="postlistpage.jsp" style="margin-top: 10px; margin-left: 10px;" class="white_font"> 후기 목록 </a></li>
      <li><a href="freeboardpage.jsp" style="margin-top: 10px; margin-left: 10px;" class="white_font"> 자유게시판 </a></li>
  ...
  <script type="text/javascript" >
    ...
    function login() {
      ...
      try {
           axios.post(`http://35.212.196.164/login/check/${id}/${pwd}`,{ withCredentials: true })
          .then(res => {
           //  res.cookies("nickname", res.data[0].nickname)
